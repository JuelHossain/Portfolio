...
const MyButton = ({ text, link, icon }) => {
  return (
    <a
      ...
      href={link}
    >
      <span className="absolute inset-0 transition-transform translate-x-1.5 translate-y-1.5 bg-yellow-400 group-hover:translate-y-0 group-hover:translate-x-0"></span>
