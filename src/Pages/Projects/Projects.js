...
const Projects = ({ home, size }) => {
  const projects = [
    ...
    },
    {
      ...
      about:
        "hahah, this is a super fun project i have done . the concept is very futuristic. basically we are selling the super powers of the superheros here. this is a simple fun projects where users can add the superheroes to the cart and checkout the products . ",
